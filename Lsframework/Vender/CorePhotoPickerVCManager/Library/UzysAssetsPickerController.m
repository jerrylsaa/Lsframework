...
- (void)viewDidLoad
{
    ...
    [_btnClose setImage:[_btnClose.currentImage imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
    [_btnClose setTintColor:[UIColor whiteColor]];
    
    _imageViewTitleArrow.image = [_imageViewTitleArrow.image imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    _imageViewTitleArrow.tintColor = [UIColor whiteColor];
    ...
    else
    {
        ...
        else if(_maximumNumberOfSelectionVideo == 0)
        {
            ...
            if(_maximumNumberOfSelection >1)
                ...
                self.labelSelectedMedia.text = @"选择一张照片";
        }
        else
        {
