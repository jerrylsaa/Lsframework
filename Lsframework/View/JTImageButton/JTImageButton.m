...
- (void)reloadTitle:(NSString *)title{
    [self setAttributedTitle:[self createStringWithImage:_iconImage string:title color:_titleColor iconPosition:_iconSide padding:_padding andIconOffsetY:_iconOffsetY] forState:UIControlStateNormal];
}
