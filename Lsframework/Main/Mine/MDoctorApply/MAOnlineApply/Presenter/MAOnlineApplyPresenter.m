...
@implementation MAOnlineApplyPresenter
...
//    userID = 8;//测试
    ...
    WS(ws);
    [[FPNetwork POST:API_QUERY_MY_ONLINE withParams:parames] addCompleteHandler:^(FPResponse *response) {
