//
//  MAFamilyDoctorApplyViewController.m
//  FamilyPlatForm
//
...
#import "MAFamilyDoctorApplyPresenter.h"
#import "FamilyDoctorApplyCell.h"

@interface MAFamilyDoctorApplyViewController ()<UITableViewDelegate,UITableViewDataSource,MApplySuccessCellDelegate,MAFamilyDoctorApplyPresenterDelegate>{
}

@property(nonatomic,retain) NSArray<MineApplyFamilyDoctorEntity*>* dataSource;

@property(nonatomic,retain) MAFamilyDoctorApplyPresenter* presenter;
...
@implementation MAFamilyDoctorApplyViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.presenter = [MAFamilyDoctorApplyPresenter new];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    FamilyDoctorApplyCell* cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
    cell.doctor = doctor;
    if(!cell.delegate){
        cell.delegate = self;
    }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [_table cellHeightForIndexPath:indexPath model:doctor keyPath:@"doctor" cellClass:[FamilyDoctorApplyCell class] contentViewWidth:[self cellContentViewWith]];
}
/**
 *  确认支付
 */
...
-(UITableView *)table{
    if(!_table){
        ...
        [_table registerClass:[FamilyDoctorApplyCell class] forCellReuseIdentifier:@"cell"];
        WS(ws);
