...
#import "PhoneCellApply.h"


@interface MAPhoneApplyViewController ()<UITableViewDelegate,UITableViewDataSource,MAPhoneDelegate,MAPhoneApplyPresenterDelegate>{
}

@property(nonatomic,retain) NSArray<MineApplyFamilyDoctorEntity*>* dataSource;
@property(nonatomic,retain) MAPhoneApplyPresenter* presenter;
@property(nonatomic,retain) UIView* noApplyView;
@property(nonatomic,retain) UITableView* table;

@end

@implementation MAPhoneApplyViewController


- (void)viewDidLoad {
    [super viewDidLoad];
    self.presenter = [MAPhoneApplyPresenter new];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    PhoneCellApply* cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
    cell.doctor = doctor;
    if(!cell.delegate){
        cell.delegate = self;
    }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [_table cellHeightForIndexPath:indexPath model:doctor keyPath:@"doctor" cellClass:[PhoneCellApply class] contentViewWidth:[self cellContentViewWith]];
}
...
-(UITableView *)table{
    if(!_table){
        ...
        [_table registerClass:[PhoneCellApply class] forCellReuseIdentifier:@"cell"];
