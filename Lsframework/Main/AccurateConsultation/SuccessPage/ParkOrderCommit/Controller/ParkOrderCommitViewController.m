//
//  ParkOrderCommitViewController.m
//  FamilyPlatForm
//
//  Created by xuwenqi on 16/4/29.
//  Copyright © 2016年 梁继明. All rights reserved.
//

#import "ParkOrderCommitViewController.h"
#import "OutpatientSuccessViewController.h"
#import "OrderCommitCell.h"



@interface ParkOrderCommitViewController ()<UITableViewDataSource,UITableViewDelegate>{
    UITableView* _table;
}
...
@implementation ParkOrderCommitViewController
...
-(void)setupView
{
    ...
    self.sectionTitle=@[@"订 单 号:",@"套餐名称:",@"资费标准:",@"优 惠 券:",@"支付方式:",@"应付金额:"];
...
- (void)commitAction{
    ...
    success.successTitle = @"稍后会有服务人员与您联系，请保持手机畅通！";
    success.titleArray = @[@"时间: 2016年3月10日09:30",@"地点: 济南市儿童医院"];
