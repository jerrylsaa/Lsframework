...
@end
@implementation HospitalZDaoCell
...
- (void)setGesellEntity:(GesellEntity *)gesellEntity{
    ...
    _firstLabel.text =[NSString stringWithFormat:@"医生指导意见：%@",gesellEntity.BEHAVIOR_OBSERV];
    _doctorLabel.text =[NSString stringWithFormat:@"测试医生：%@",gesellEntity.UserName];
    _hospitalLabel.text =[NSString stringWithFormat:@"测试医院：%@",gesellEntity.HName];
