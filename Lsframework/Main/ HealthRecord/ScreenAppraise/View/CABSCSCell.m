...
- (void)setXllbEntity:(XLLBEntity *)xllbEntity{
    ...
    _titleLabel.text =@"克氏孤独症行为量表测试";
    _firstLabel.text =[NSString stringWithFormat:@"测试分数：%@",xllbEntity.ScaleStandard_Result];
    _secondLabel.text=[NSString stringWithFormat:@"诊断结果：%@",xllbEntity.ScaleText_Result];
}
