...
@interface GJTJZDViewController ()<UITableViewDataSource,UITableViewDelegate>

@property (nonatomic,retain) UITableView *table;

@end

@implementation GJTJZDViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    GJTJZDCell * cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    
    if (cell==nil) {
        cell = [[GJTJZDCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //        return 80;
    //    }
    return [_table cellHeightForIndexPath:indexPath model:self.xllbDataSource[indexPath.row] keyPath:@"xllbEntity" cellClass:[GJTJZDCell class] contentViewWidth:[self cellContentViewWith]]+60;
}
