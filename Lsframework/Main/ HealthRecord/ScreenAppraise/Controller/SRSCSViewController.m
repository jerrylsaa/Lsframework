...
#import "SRSCSViewController.h"
#import "SRSCSCell.h"
#import "UITableView+SDAutoTableViewCellHeight.h"

@interface SRSCSViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation SRSCSViewController
...
- (void)viewDidLoad {
    ...
    _tableNameArr =@[@"知觉",@"认知",@"交流",@"动机",@"行为方式",@"总量表得分"];
}
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SRSCSCell * cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    
    if (cell==nil) {
        cell = [[SRSCSCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [_table cellHeightForIndexPath:indexPath model:self.xllbDataSource[numb] keyPath:@"xllbEntity" cellClass:[SRSCSCell class] contentViewWidth:[self cellContentViewWith]]+60;
}
