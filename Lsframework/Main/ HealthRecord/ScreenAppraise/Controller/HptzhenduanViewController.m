...
@interface HptzhenduanViewController ()<UITableViewDataSource,UITableViewDelegate>

@property(nonatomic,retain) UITableView *table;

@end

@implementation HptzhenduanViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HospitalZDCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    
    if (cell==nil) {
        cell = [[HospitalZDCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //        return 80;
    //    }
    return [_table cellHeightForIndexPath:indexPath model:self.gesellDataSource[indexPath.row] keyPath:@"gesellEntity" cellClass:[HospitalZDCell class] contentViewWidth:[self cellContentViewWith]]+60;
}
