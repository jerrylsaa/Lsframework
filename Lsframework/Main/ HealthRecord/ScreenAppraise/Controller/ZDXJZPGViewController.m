...
@interface ZDXJZPGViewController ()<XLLBPresenterDelegate,PageViewDelegate>
@property (nonatomic, strong)PageView *pageView;
@property (nonatomic,strong) XLLBPresenter *presenter;

@end

@implementation ZDXJZPGViewController
...
- (void)setupView{
    ...
    self.presenter.tableName =@"ZDXJZPG";
    [self setupPage];
...
- (void)onCompletion:(BOOL)success info:(NSString *)messsage{
    if(success){
        ZDXJZPGCSViewController *ceshiVC =[ZDXJZPGCSViewController new];
