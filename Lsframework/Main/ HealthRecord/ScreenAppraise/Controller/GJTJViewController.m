...
@interface GJTJViewController ()<XLLBPresenterDelegate,PageViewDelegate>
@property (nonatomic, strong)PageView *pageView;
@property (nonatomic,strong) XLLBPresenter *presenter;

@end

@implementation GJTJViewController
...
- (void)onCompletion:(BOOL)success info:(NSString *)messsage{
    if(success){
        GJTJCSViewController *ceshiVC =[GJTJCSViewController new];
