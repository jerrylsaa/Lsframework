...
@interface GJTJZDaoViewController ()<UITableViewDataSource,UITableViewDelegate>

@property (nonatomic,retain) UITableView *table;

@end

@implementation GJTJZDaoViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    GJTJZDaoCell * cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    
    if (cell==nil) {
        cell = [[GJTJZDaoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //        return 80;
    //    }
    return [_table cellHeightForIndexPath:indexPath model:self.xllbDataSource[indexPath.row] keyPath:@"xllbEntity" cellClass:[GJTJZDaoCell class] contentViewWidth:[self cellContentViewWith]]+60;
}
