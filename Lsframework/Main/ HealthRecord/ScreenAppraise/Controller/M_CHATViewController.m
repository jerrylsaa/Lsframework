...
#import "PageView.h"
@interface M_CHATViewController ()<XLLBPresenterDelegate,PageViewDelegate>
...
@implementation M_CHATViewController
...
- (void)setupView{
    ...
    self.presenter.tableName =@"M_CHAT";
    [self setupPage];
...
- (void)onCompletion:(BOOL)success info:(NSString *)messsage{
    if(success){
        M_CHATCSViewController *ceshiVC =[M_CHATCSViewController new];
