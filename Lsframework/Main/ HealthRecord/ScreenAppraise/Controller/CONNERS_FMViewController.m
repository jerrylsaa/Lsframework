...
#import "PageView.h"
@interface CONNERS_FMViewController ()<XLLBPresenterDelegate,PageViewDelegate>
...
@implementation CONNERS_FMViewController
...
- (void)setupView{
    ...
    self.presenter.tableName =@"CONNERS_FM";
    [self setupPage];
...
- (void)onCompletion:(BOOL)success info:(NSString *)messsage{
    if(success){
        CONNERS_FMCSViewController *ceshiVC =[CONNERS_FMCSViewController new];
