...
#import "SNAP_IVCSViewController.h"
#import "SNAP_IVCSCell.h"
#import "UITableView+SDAutoTableViewCellHeight.h"

@interface SNAP_IVCSViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation SNAP_IVCSViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SNAP_IVCSCell * cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    
    if (cell==nil) {
        cell = [[SNAP_IVCSCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [_table cellHeightForIndexPath:indexPath model:self.xllbDataSource[numb] keyPath:@"xllbEntity" cellClass:[SNAP_IVCSCell class] contentViewWidth:[self cellContentViewWith]]+60;
}
