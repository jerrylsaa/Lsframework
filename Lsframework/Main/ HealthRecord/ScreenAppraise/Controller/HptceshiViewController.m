...
@interface HptceshiViewController ()<UITableViewDataSource,UITableViewDelegate>

@property(nonatomic,retain) UITableView *table;

@end

@implementation HptceshiViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HospitalCSCell* cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    
    if (cell==nil) {
        cell = [[HospitalCSCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
//        return 80;
//    }
    return [_table cellHeightForIndexPath:indexPath model:self.gesellDataSource[indexPath.row] keyPath:@"gesellEntity" cellClass:[HospitalCSCell class] contentViewWidth:[self cellContentViewWith]]+60;
}
