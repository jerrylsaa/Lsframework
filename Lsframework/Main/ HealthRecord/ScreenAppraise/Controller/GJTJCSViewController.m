...
#import "GJTJCSViewController.h"
#import "GJTJTableViewCell.h"
#import "UITableView+SDAutoTableViewCellHeight.h"

@interface GJTJCSViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation GJTJCSViewController
...
- (void)viewDidLoad {
    ...
    _tableNameArr =@[@"前庭平衡和大脑双侧分化情况",@"触觉防御功能",@"本体感觉和身体协调功能"];
}
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    GJTJTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    
    if (cell==nil) {
        cell = [[GJTJTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [_table cellHeightForIndexPath:indexPath model:self.xllbDataSource[numb] keyPath:@"xllbEntity" cellClass:[GJTJTableViewCell class] contentViewWidth:[self cellContentViewWith]]+60;
}
