...
@interface HospitalDDSTViewController ()<PageViewDelegate,HospitalDDSTPresenterDelegate>
@property (nonatomic, strong)PageView *pageView;
@property (nonatomic,strong) HospitalDDSTPresenter *presenter;
@end

@implementation HospitalDDSTViewController

- (void)viewDidLoad {
    [super viewDidLoad];

    [self.presenter getDDSTData];
...
- (void)setupView{
    ...
    self.presenter =[HospitalDDSTPresenter new];
...
- (void)onCompletion:(BOOL)success info:(NSString *)messsage{
    if(success){
        DDSTCSViewController *ceshiVC =[DDSTCSViewController new];
        ceshiVC.ddstDataSource =self.presenter.ddstDataSource;
        
        
        
        DDSTZDaoViewController *zhidaoVC =[DDSTZDaoViewController new];
        zhidaoVC.ddstDataSource =self.presenter.ddstDataSource;
