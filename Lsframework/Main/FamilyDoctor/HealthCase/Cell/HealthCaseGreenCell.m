...
@implementation HealthCaseGreenCell
...
- (void)setupSubviews{
    ...
    _bgImageView.image = [UIImage imageNamed:@"doctor_timeLine_green"];
    ...
    cirle.backgroundColor = UIColorFromRGB(0x2DAB9F);
    ...
    //添加约束
    _msgLabel.sd_layout.topSpaceToView(_bgImageView,10).leftSpaceToView(_bgImageView,20).rightSpaceToView(_bgImageView,25).autoHeightRatio(0);
    
    _bgImageView.sd_layout.topSpaceToView(containerView,10).leftSpaceToView(containerView,5).widthIs(kScreenWidth/2.0-10);
    [_bgImageView setupAutoHeightWithBottomView:_msgLabel bottomMargin:10];
    
    containerView.sd_layout.topEqualToView(self.contentView).leftEqualToView(self.contentView).widthIs(kScreenWidth/2.0);
    [containerView setupAutoHeightWithBottomView:_bgImageView bottomMargin:10];
    
    cirle.sd_layout.centerYEqualToView(_bgImageView).heightIs(8).widthEqualToHeight().leftSpaceToView(_bgImageView,1);
    ...
    _timeLabel.sd_layout.centerYEqualToView(cirle).heightIs(10).leftSpaceToView(cirle,5).widthIs(kScreenWidth/2.0);
