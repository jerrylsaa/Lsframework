...
@implementation ECouponTableViewCell
...
-(void)setupSubviews{
    ...
    _CouponImageView.userInteractionEnabled = YES;
    ...
    [_CouponBtn setImage:[UIImage  imageNamed:@"COUPON_NoSelect"] forState:UIControlStateNormal];
    [_CouponBtn setImage:[UIImage  imageNamed:@"COUPON_Select"] forState:UIControlStateSelected];
    _CouponBtn.backgroundColor = [UIColor  clearColor];
    [_CouponImageView   addSubview:_CouponBtn];
    
    int  CouponNametop = 25/2;
    int  CouponTypetop = 102/2;
    int  CouponMoneybottom = 70/2;
    int  CouponBtnbottom = 22/2;
    int  CouponBtnRight = 22/2;
    ...
    _CouponBtn.sd_layout.bottomSpaceToView(_CouponImageView,CouponBtnbottom).rightSpaceToView(_CouponImageView,0).widthIs(80/2).heightIs(80/2);
...
- (void)setIsSelected:(BOOL)isSelected{
    ...
    self.CouponBtn.selected =isSelected;
