...
#import "MessageUnReadViewController.h"
#import "MessageTableViewCell.h"
#import "MessagePresenter.h"
#import "JMChatViewController.h"

@interface MessageUnReadViewController ()<MessagePresnterDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic, strong) MessagePresenter * presenter;
@end

@implementation MessageUnReadViewController
