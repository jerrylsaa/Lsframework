...
@implementation ConcentationCell
...
-(void)setTodayRecommend:(TodayRecommend *)todayRecommend
{
    ...
    if (tags.length != 0 ) {
        ...
        for (int i = 0 ; i<tagArr.count; i++) {
            ...
            tagSSView.layer.borderColor = UIColorFromRGB(0x2dcbc4).CGColor;
            [self.TagView  addSubview:tagSSView];
            
            UILabel  *tagLb = [UILabel new];
            tagLb.textColor = UIColorFromRGB(0x2dcbc4);
